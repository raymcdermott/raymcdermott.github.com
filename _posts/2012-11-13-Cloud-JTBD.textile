...
What is the "job to be done":http://hbswk.hbs.edu/item/5170.html by the cloud? I see several answers around the web including
...
So the others can reach a global audience but cannot share that access. They have a platform that is proven to scale and they are willing to share the love, for a price.  Which is an attractive though less powerful proposition.

And that's all well and good if one believes that the cloud vs business capability gap is here to stay. I am convinced that the gap is both reducing and will soon be eliminated for all practical purposes.

So, what do you need to scale?
- elastic compute resources (job to be done: ensure scale to meet unpredictable demands)
- provisioning and self-service facilities (job to be done: provide developer and ultimately user convenience)
- fast networks with carrier grade connectivity (job to be done: provide bandwidth needed to meet unpredictable demands)
...
The single most persuasive argument for large scale cloud adoption is to allow corporate management to reboot IS are at least significant parts of it.  And I share that temptation.

Whilst I'm all for integrating with companies that can add value from the cloud I don't advise migrating business up there wholesale. Within five years the gap will only exist for derelicts.
