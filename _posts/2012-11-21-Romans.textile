...
In fairness, Lisps in general seems magical.  When I first saw that "(* 1 2 3 4)" equals 24 it was a bit of a shock to the system.
...
So I'm all for inter-religious understanding, even off the JVM.
